  ...
  useEffect(() => {
    if (location.state?.success) {
      setNotification({
        ...
        isWarning: location.state.isWarning
      });
    }
  }, []);
    ...
    <section
      ...
      <div className="bg-[#ECF0FF] w-full max-w-4xl h-[36rem] flex rounded shadow-lg overflow-hidden dark:bg-[#3d3a37]">
        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
          ...
          {notification && (
            <div className={`${notification.isWarning ? "bg-yellow-100 border-yellow-400 text-yellow-800" : "bg-green-100 border-green-400 text-green-800"} border px-4 py-3 rounded mb-4 text-sm flex justify-between items-center gap-3`}>
