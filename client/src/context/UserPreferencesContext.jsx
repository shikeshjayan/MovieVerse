...
export const UserPreferencesProvider = ({ children }) => {
  const { isAuthenticated, isRegistrationFlow, setIsRegistrationFlow, user } = useAuth();
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && !hasOnboarded && !isLoading && totalItems < 5 && !isRegistrationFlow && !isAdmin) {
      setShowOnboarding(true);
    } else {
      setShowOnboarding(false);
    }
  }, [isAuthenticated, hasOnboarded, isLoading, totalItems, isRegistrationFlow, user]);
