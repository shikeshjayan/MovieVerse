...
export const updateReview = catchAsync(async (req, res, next) => {
  ...
  const review = await Review.findByIdAndUpdate(reviewId, update, { returnDocument: 'after' })
    .populate("user", "username email avatar");
...
export const bulkDeleteReviews = catchAsync(async (req, res, next) => {
...
export const bulkHideReviews = catchAsync(async (req, res, next) => {
  const { reviewIds } = req.body;
...
export const clearReport = catchAsync(async (req, res, next) => {
  const { reviewId } = req.params;
...
export const getReportedReviews = catchAsync(async (req, res, next) => {
